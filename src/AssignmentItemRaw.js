    ...
    return (
        <>
            <div className="pt-3 pb-3 d-none d-lg-flex flex-row align-items-center justify-content-around align-self-stretch">
                {props.id % 2 ? <Image id="image" src={props.image} style={{ height: "350px", width: "650px", objectFit: "cover", border: "1px solid " + (props.forDark?"#fff":"#02141e") }}/> : ""}
            ...
            <div className="mb-5 mt-3 d-lg-none flex-column align-items-center">
                <Image id="image" src={props.image} style={{ height: "50vw", width: "90vw", objectFit: "cover", border: "1px solid " + (props.forDark?"#fff":"#02141e") }}/>
